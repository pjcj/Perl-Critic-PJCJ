...
Readonly::Scalar my $EXPL => q{Simple strings (containing no double quotes or @ symbols) should use double quotes for consistency};
...
Perl::Critic::Policy::ValuesAndExpressions::RequireDoubleQuotedStrings - Use double quotes for simple strings
