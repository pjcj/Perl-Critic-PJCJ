...
subtest "Condition coverage tests" => sub {
  ...
  good_code 'my $x = "simple";', "simple double quoted string is acceptable";
};
...
subtest "Use statement structure parsing" => sub {
  ...
  check_message 'use Foo "arg1", "arg2";', "use qw()",
  ...
  check_message 'use Foo "arg1", "arg2", "arg3"', "use qw()",
